...
const Chats = () => {
  ...
  return (
    <>
    {chats.map((chat) => (
        <a href="#"  onClick={() => handleSelect(chat)} className="list-group-item list-group-item-action border-0" style={{ margin: "10px 5px 10px 0", paddingLeft: "5px" }}>
          <div className="d-flex align-items-start">
            <img src={chat.imageUrl ? chat.imageUrl : "../../assets/img/avatars/avatar-2.jpg"} className="rounded-circle me-1" alt="Vanessa Tucker" width="40" height="40" />
